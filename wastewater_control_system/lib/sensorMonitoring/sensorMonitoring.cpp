...
void sensorMonitoringTask(void* parameters) {
    ...
    while (true) {
        ...
        pushSensorReading("ph", pHSensor_Tank06.get_name(), ph_t06);
        ...
        pushSensorReading("dissolved02",doSensor_Tank07.get_name(), do_t07);
        pushSensorReading("temperature",tempSensor_Tank01.get_name(), temp_t01);
